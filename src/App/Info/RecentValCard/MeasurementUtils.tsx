...
export const getCategoryText = (value: number, ranges: RangeEntry[]): string => {
  // Sort descending, then find the first range where value is >= the minimum bound
  const matchedRange = [...ranges]
    .sort((a, b) => b.range[0] - a.range[0])
    .find(r => value >= r.range[0]);

  return matchedRange?.category || "Unknown";
};